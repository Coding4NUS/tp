...
public class EditCommand extends Command {
    ...
    public static final String COMMAND_PARAMETERS =
            PREFIX_INDEXES + "INDEX (must be a positive integer) "
            + "[" + PREFIX_NAME + "NAME] "
            + "[" + PREFIX_PHONE + "PHONE] "
            + "[" + PREFIX_EMAIL + "EMAIL] "
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        return new Person(personToEdit, updatedName, updatedPhone, updatedEmail, updatedMatricNumber, updatedTags);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, email, matricNumber, tags);
        }
        ...
        public boolean equals(Object other) {
            ...
            return Objects.equals(name, otherEditPersonDescriptor.name)
                    ...
                    && Objects.equals(matricNumber, otherEditPersonDescriptor.matricNumber)
