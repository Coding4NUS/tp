...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_MATRIC_NUMBER_AMY
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + MATRIC_NUMBER_DESC_AMY + EMAIL_DESC_AMY
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_MATRIC_NUMBER_DESC + INVALID_EMAIL_DESC
